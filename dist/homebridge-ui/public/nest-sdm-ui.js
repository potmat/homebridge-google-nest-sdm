...
async function initiateAuthFlow() {
    ...
    window.open(`https://nestservices.google.com/partnerconnections/${projectId}/auth?redirect_uri=https://www.google.com&access_type=offline&prompt=consent&client_id=${clientId}&response_type=code&scope=https://www.googleapis.com/auth/sdm.service+https://www.googleapis.com/auth/pubsub`);
}
function updateAuthUiState(currentConfig) {
    const enableUi = !!currentConfig[0].clientId &&
...
async function onAuthUrlInput(e) {
    var _a, _b;
    const currentUrl = (_b = (_a = e.target) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : '';
...
//# sourceMappingURL=nest-sdm-ui.js.map