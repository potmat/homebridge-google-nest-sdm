...
**NEW!** We now provide an automated setup script that streamlines the Google Cloud Platform configuration process.

### Quick Start

For a simplified setup experience, check out our **[comprehensive setup guide](SETUP.md)** with automated scripts that handle most of the GCP configuration for you.

**Features:**

- 🤖 Automated GCP project creation and API enablement
- ✅ Interactive guided setup process
- 🔍 Built-in verification and troubleshooting tools
- 📋 Generates ready-to-use Homebridge configuration
- ⚡ Reduces setup time from 1-2 hours to ~15 minutes
...
The script will guide you through the entire setup process, including the manual OAuth steps, and generate your configuration file automatically.
...
See the **[SETUP.md](SETUP.md)** guide for detailed instructions, or continue reading below for manual setup.
